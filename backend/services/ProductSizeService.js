// services/productSizeService.js
const ProductSizeModel = require('../models/ProductSizeModel');
//
// // Create Product Size
// const createProductSize = async (name) => {
//   const productSize = new ProductSizeModel({ name });
//   return await productSize.save();
// };
//
// // Update Product Size by ID
// const updateProductSize = async (id, name) => {
//   return await ProductSizeModel.findByIdAndUpdate(id, { name }, { new: true });
// };
//
