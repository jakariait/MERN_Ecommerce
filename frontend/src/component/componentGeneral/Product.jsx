...
//
//   return (
//     <div className="container md:mx-auto px-3 py-10 justify-center md:justify-start">
//       {loading ? (
//         <>
...
//             <Typography
//               variant="body1"
//               className="text-center text-gray-500 p-70 shadow rounded-lg mt-5"
//             >
...
//                     </Typography>
//                   </Link>
//                   <div className="flex gap-2 primaryTextColor">
//                     <Typography variant="body2">
//                       Tk. {formatPrice(Number(product.baseDiscount))}
//                     </Typography>
//                     <Typography
//                       variant="body2"
//                       style={{ textDecoration: "line-through" }}
//                     >
//                       Tk. {formatPrice(Number(product.basePrice))}
//                     </Typography>
//                   </div>
//                 </Grid>
//               ))}
